...
const Participate = () => (
  <Section title="Participate in tasks" subheading="For builders and curators" lightOn>
    <ProductShot
    ...
    >
      <p>
        All the contributors on a task receive a onchain non-transferable NFT (ERC-721) as a
    ...
    >
      <p>
        Review Work and submit Proposals of task payment distributions, curate the Bepro
        Marketplaces and earn crypto.
      </p>
    </ProductShot>
  </Section>
);
